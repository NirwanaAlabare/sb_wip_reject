    ...
    <div class="row g-3">
        ...
        <div class="col-12 col-md-12 {{ $mode != "in" ? 'd-none' : ''}}">
            <div class="card">
                ...
                <div class="card-body">
                    <input type="hidden" class="d-none qty-input border h-100" id="selectedItemRejectId" name="selectedItemRejectId" readonly>
                    <div class="row">
                        <div class="col-md-12">
                                ...
                                <div class="col-md-3">
                                    <div class="card">
                                        ...
                                        <div class="card-body p-0">
                                            <h5 class="text-center mb-0"><b>{{ $totalRejectIn }}</b></h5>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        @else
                                            @foreach ($rejectInList as $rejectIn)
                                                ...
                                                <tr class="text-center align-middle">
                                                    ...
                                                    {{-- <td>{{ ($rejectIn->kode_numbering ? $rejectIn->kode_numbering : "-") }}</td> --}}
                                                    ...
                                                    <td><button class="btn btn-sm btn-reject fw-bold" onclick='preSubmitRejectIn({{ $rejectIn->id }}, "{{ $rejectIn->output_type }}")'>IN</button></td>
                                                </tr>
                                            @endforeach
                                        @endif
                                    </tbody>
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-lg">
            <div class="modal-content">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" wire:model="selectedRejectId" readonly>
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="mb-3">
                ...
                <div class="modal-footer justify-content-between gap-1">
                    <div>
                        <div class="d-flex justify-content-end align-items-center {{ $rejectInQuality && $rejectInQuality == "rejected" ? "" : "d-none" }}">
...
@push('scripts')
    ...
    <script>
        ...
        function preSubmitRejectIn(id, type) {
            @this.selectedRejectId = id;
            @this.rejectInOutputTypeModal = type;
